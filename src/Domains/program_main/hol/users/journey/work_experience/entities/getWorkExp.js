...
class GetExp {
  constructor(payload) {
    ...
    const { id_users_hol, company_name, start_date, end_date, position } = payload;
    (this.holUsersId = id_users_hol), (this.companyName = company_name), (this.startDate = start_date), (this.endDate = end_date), (this.position = position);
  }
