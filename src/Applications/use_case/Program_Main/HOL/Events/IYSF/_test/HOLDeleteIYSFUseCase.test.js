...
const DeleteIYSFUseCase = require('../HOLDeleteIYSFUseCase');

describe('DeleteIYSFUseCase', () => {
  ...
  it('should orchestrate the delete bonding activity correctly (happy path)', async () => {
    ...
    const useCase = new DeleteIYSFUseCase({ holEventsRepository: mockHolEventsRepository });
