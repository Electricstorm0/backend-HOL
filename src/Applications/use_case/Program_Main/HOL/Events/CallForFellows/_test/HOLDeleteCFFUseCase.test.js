...
const DeleteCFFUseCase = require('../HOLDeleteCFFUseCase');

describe('DeleteCFFUseCase', () => {
  ...
  it('should orchestrate the delete bonding activity correctly (happy path)', async () => {
    ...
    const useCase = new DeleteCFFUseCase({ holEventsRepository: mockHolEventsRepository });
